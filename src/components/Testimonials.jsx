...
const Testimonials = () => {
  return (
    <div className='mt-20 tracking-wide'>
      <h2 className='text-3xl sm:text-5xl lg:text-6xl text-center my-8 tracking-wide'>What people are saying</h2>
          ...
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 py-2">
            <div className="border border-neutral-800 bg-neutral rounded-md p-6 text-md font-thin">
              ...
              <div className="flex mt-8 items-start">
                <img src={testimonial.image} alt={testimonial.user} className='w-12 h-12 mr-6 rounded-full border border-neutral-700' />
                <div>
